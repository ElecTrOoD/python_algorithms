...
# Вывод. Функция sieve() имеет линейную зависимость, функция prime() квадратичную. За счёт класической проверки на
# делимость функция prime() работает ощутимо медленнее.
